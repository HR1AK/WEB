    ...
    <body>
       <!--Шапка сайта-->
		...
		<div class="container-fluid mx-auto" style="width: 95%;">
			...
			<a href="create.php" type="button" name ="" value = "" class="btn btn-info">Добавить</a>
                ...
                <?php
                    foreach($data as $data)
                    {
                        ...
                        <tr>
                            ...
                            <th class = "col-2"><?= $data[4]?></th>
                            <th class = "col-1"><?= $data[5]?></th>

							<th class = "col-1">
								<a href="update.php?id=<?= $data[0] ?>" type="button" name ="update_button" value = "" class="btn btn-primary">Редактировать</a>
                            </th>

							<th class = "col-1">
								<a href="delete.php?id=<?= $data[0] ?> >" type="button" name ="delete_button" value = "" class="btn btn-danger">Удалить</a>
                            </th>
                        </tr>
